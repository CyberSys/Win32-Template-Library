...
namespace wtl
{
  ...
  struct LocalFileStream 
  {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
    // LocalFileStream::~LocalFileStream
    //! Virtual d-tor, closes the file handle
    //////////////////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    position_t position() const
    {
      ...
      return Handle ? static_cast<position_t>(ftell(Handle)) / sizeof(element_t) : zero<position_t>::value;
    }
    ...
    distance_t  read(std::remove_const_t<element_t>* buffer, distance_t length)
    {
      ...
      return Handle ? fread(buffer, sizeof(element_t), length, Handle) : zero<distance_t>::value;
    }
