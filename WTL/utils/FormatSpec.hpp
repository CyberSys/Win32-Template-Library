...
//! \if CONSTEXPR_CAP - Define here if compiler supports static storage
  ...
  template <> struct format_spec<char,double>      { static constexpr string_literal_t value = "%llf"; };
  template <> struct format_spec<char,uint64>      { static constexpr string_literal_t value = "%llu"; };
  template <> struct format_spec<char,int64>       { static constexpr string_literal_t value = "%lld"; };
  template <> struct format_spec<char,float>       { static constexpr string_literal_t value = "%lf";  };
  template <> struct format_spec<char,ulong32>     { static constexpr string_literal_t value = "%lu";  };
  template <> struct format_spec<char,long32>      { static constexpr string_literal_t value = "%ld";  };
  template <> struct format_spec<char,uint32>      { static constexpr string_literal_t value = "%lu";  };
  template <> struct format_spec<char,int32>       { static constexpr string_literal_t value = "%ld";  };
  template <> struct format_spec<char,uint16>      { static constexpr string_literal_t value = "%hu";  };
  template <> struct format_spec<char,int16>       { static constexpr string_literal_t value = "%hd";  };
  template <> struct format_spec<char,uint8>       { static constexpr string_literal_t value = "%c";  };
  template <> struct format_spec<char,int8>        { static constexpr string_literal_t value = "%c";  };
  template <> struct format_spec<char,char>        { static constexpr string_literal_t value = "%c";  };
  template <> struct format_spec<char,char*>       { static constexpr string_literal_t value = "%s";  };
  template <> struct format_spec<char,const char*> { static constexpr string_literal_t value = "%s";  };
#else
  /////////////////////////////////////////////////////////////
  //! \struct format_spec - Defines printf type specification for fundemental types
  /////////////////////////////////////////////////////////////
