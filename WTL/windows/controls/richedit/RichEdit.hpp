...
#include <wtl/windows/controls/richedit/RichEditConstants.hpp>            //!< (Constants)
...
namespace wtl 
{
  ...
  public:
    ...
    {
      static const String<encoding> name("WTL.RichEdit");
    ...
    LResult route(WindowMessage message, WPARAM w, LPARAM l) override
    {
      try
      {
        ...
        case WindowMessage::ReflectCommand:  
          ...
          switch (static_cast<RichEditNotification>(code))
          {
