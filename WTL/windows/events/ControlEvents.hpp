////////////////////////////////////////////////////////////////////////////////
//! \file wtl\windows\events\ControlEvents.hpp
//! \brief Provides argument/delegate/handler types for events from controls 
//! \date 6 March 2015
//! \author Nick Crowley
...
namespace wtl
{
  ...
  ///////////////////////////////////////////////////////////////////////////////
  template <Encoding ENC, typename SENDER, ButtonEvent CODE> using ButtonEventHandler = CommandEventHandler<ENC,SENDER,ButtonEvent,CODE>;
  ...
  template <Encoding ENC, typename SENDER> using ListViewBeginLabelEditEventHandler = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::BeginLabelEditA,ListViewEvent::BeginLabelEditW>>; 
  ...
  template <Encoding ENC, typename SENDER> using ListViewEndLabelEditEventHandler   = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::EndLabelEditA,ListViewEvent::EndLabelEditW>>; 	
  ...
  template <Encoding ENC, typename SENDER> using ListViewGetDispInfoEventHandler    = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::GetDispInfoA,ListViewEvent::GetDispInfoW>>; 				
  ...
  template <Encoding ENC, typename SENDER> using ListViewGetInfoTipEventHandler     = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::GetInfoTipA,ListViewEvent::GetInfoTipW>>; 				
  ...
  template <Encoding ENC, typename SENDER> using ListViewIncrementalSearchEventHandler = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::IncrementalSearchA,ListViewEvent::IncrementalSearchW>>; 	
  ...
  template <Encoding ENC, typename SENDER> using ListViewSetDispInfoEventHandler    = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::SetDispInfoA,ListViewEvent::SetDispInfoW>>; 
  ...
  template <Encoding ENC, typename SENDER> using VirtualListViewFindItemEventHandler     = ListViewEventHandler<ENC,SENDER,getType_t<ENC,ListViewEvent::OdFindItemA,ListViewEvent::OdFindItemW>>;
